...
(async function () {
    ...
    for (const n of NODES_TO_SYNC) {
        ...
        const cometConfig = TOML.parse(configToml) as any;
...
async function nodeQuery(n: number, query: string) {
