...
function createBaseApi(): Api {
  return { name: "", methods: [], options: [], version: "", source_context: undefined, mixins: [], syntax: 0 };
}
...
export const Method: MessageFns<Method> = {
  ...
  fromJSON(object: any): Method {
    return {
      name: isSet(object.name) ? globalThis.String(object.name) : "",
      request_type_url: isSet(object.request_type_url) ? globalThis.String(object.request_type_url) : "",
      request_streaming: isSet(object.request_streaming) ? globalThis.Boolean(object.request_streaming) : false,
      response_type_url: isSet(object.response_type_url) ? globalThis.String(object.response_type_url) : "",
      response_streaming: isSet(object.response_streaming) ? globalThis.Boolean(object.response_streaming) : false,
      options: globalThis.Array.isArray(object?.options) ? object.options.map((e: any) => Option.fromJSON(e)) : [],
      syntax: isSet(object.syntax) ? syntaxFromJSON(object.syntax) : 0,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Method>, I>>(object: I): Method {
    const message = createBaseMethod();
    message.name = object.name ?? "";
    message.request_type_url = object.request_type_url ?? "";
    message.request_streaming = object.request_streaming ?? false;
    message.response_type_url = object.response_type_url ?? "";
    message.response_streaming = object.response_streaming ?? false;
    message.options = object.options?.map((e) => Option.fromPartial(e)) || [];
    message.syntax = object.syntax ?? 0;
    return message;
  },
