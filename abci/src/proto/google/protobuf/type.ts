...
function createBaseType(): Type {
  return { name: "", fields: [], oneofs: [], options: [], sourceContext: undefined, syntax: 0, edition: "" };
}
...
function createBaseEnum(): Enum {
  return { name: "", enumvalue: [], options: [], sourceContext: undefined, syntax: 0, edition: "" };
}
...
export const Enum: MessageFns<Enum> = {
  encode(message: Enum, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.sourceContext !== undefined) {
      SourceContext.encode(message.sourceContext, writer.uint32(34).fork()).join();
    }
    if (message.syntax !== 0) {
