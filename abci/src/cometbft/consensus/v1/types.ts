...
export const Message: MessageFns<Message> = {
  encode(message: Message, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.hasProposalBlockPart !== undefined) {
      HasProposalBlockPart.encode(message.hasProposalBlockPart, writer.uint32(82).fork()).join();
    }
    return writer;
  },
  ...
  toJSON(message: Message): unknown {
    ...
    if (message.hasProposalBlockPart !== undefined) {
      obj.hasProposalBlockPart = HasProposalBlockPart.toJSON(message.hasProposalBlockPart);
    }
    return obj;
  },
