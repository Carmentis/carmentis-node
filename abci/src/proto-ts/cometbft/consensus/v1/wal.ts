...
export interface MsgInfo {
  ...
  peer_id: string;
  receive_time?: Timestamp | undefined;
}
...
function createBaseMsgInfo(): MsgInfo {
  return { msg: undefined, peer_id: "", receive_time: undefined };
}
...
export const MsgInfo: MessageFns<MsgInfo> = {
  encode(message: MsgInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.receive_time !== undefined) {
      Timestamp.encode(message.receive_time, writer.uint32(26).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.receive_time = Timestamp.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): MsgInfo {
    return {
      ...
      receive_time: isSet(object.receive_time) ? fromJsonTimestamp(object.receive_time) : undefined,
    };
  },
  ...
  toJSON(message: MsgInfo): unknown {
    ...
    if (message.receive_time !== undefined) {
      obj.receive_time = fromTimestamp(message.receive_time).toISOString();
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<MsgInfo>, I>>(object: I): MsgInfo {
    ...
    message.receive_time = (object.receive_time !== undefined && object.receive_time !== null)
      ? Timestamp.fromPartial(object.receive_time)
      : undefined;
    return message;
  },
};
...
export const WALMessage: MessageFns<WALMessage> = {
  encode(message: WALMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.event_data_round_state !== undefined) {
      EventDataRoundState.encode(message.event_data_round_state, writer.uint32(10).fork()).join();
    }
    if (message.msg_info !== undefined) {
      MsgInfo.encode(message.msg_info, writer.uint32(18).fork()).join();
    }
    if (message.timeout_info !== undefined) {
      TimeoutInfo.encode(message.timeout_info, writer.uint32(26).fork()).join();
    }
    if (message.end_height !== undefined) {
      EndHeight.encode(message.end_height, writer.uint32(34).fork()).join();
    }
    return writer;
  },
