...
export interface Message {
  ...
  has_proposal_block_part?: HasProposalBlockPart | undefined;
}
...
function createBaseHasProposalBlockPart(): HasProposalBlockPart {
  return { height: 0, round: 0, index: 0 };
}

export const HasProposalBlockPart: MessageFns<HasProposalBlockPart> = {
  encode(message: HasProposalBlockPart, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.height !== 0) {
      writer.uint32(8).int64(message.height);
    }
    if (message.round !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): HasProposalBlockPart {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<HasProposalBlockPart>, I>>(base?: I): HasProposalBlockPart {
    return HasProposalBlockPart.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<HasProposalBlockPart>, I>>(object: I): HasProposalBlockPart {
    const message = createBaseHasProposalBlockPart();
    message.height = object.height ?? 0;
    message.round = object.round ?? 0;
    message.index = object.index ?? 0;
...
function createBaseMessage(): Message {
  return {
    ...
    has_proposal_block_part: undefined,
  };
}
...
export const Message: MessageFns<Message> = {
  encode(message: Message, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.has_proposal_block_part !== undefined) {
      HasProposalBlockPart.encode(message.has_proposal_block_part, writer.uint32(82).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10: {
          ...
          message.has_proposal_block_part = HasProposalBlockPart.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Message {
    return {
      ...
      has_proposal_block_part: isSet(object.has_proposal_block_part)
        ? HasProposalBlockPart.fromJSON(object.has_proposal_block_part)
        : undefined,
    };
  },
  ...
  toJSON(message: Message): unknown {
    ...
    if (message.has_proposal_block_part !== undefined) {
      obj.has_proposal_block_part = HasProposalBlockPart.toJSON(message.has_proposal_block_part);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Message>, I>>(object: I): Message {
    ...
    message.vote_set_bits = (object.vote_set_bits !== undefined && object.vote_set_bits !== null)
      ...
      : undefined;
    message.has_proposal_block_part =
      (object.has_proposal_block_part !== undefined && object.has_proposal_block_part !== null)
        ? HasProposalBlockPart.fromPartial(object.has_proposal_block_part)
        : undefined;
    return message;
  },
};
