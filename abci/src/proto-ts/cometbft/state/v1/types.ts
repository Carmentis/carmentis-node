...
function createBaseABCIResponsesInfo(): ABCIResponsesInfo {
  return { legacy_abci_responses: undefined, height: 0, finalize_block: undefined };
}
...
export const ABCIResponsesInfo: MessageFns<ABCIResponsesInfo> = {
  encode(message: ABCIResponsesInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.finalize_block !== undefined) {
      FinalizeBlockResponse.encode(message.finalize_block, writer.uint32(26).fork()).join();
    }
    return writer;
  },
