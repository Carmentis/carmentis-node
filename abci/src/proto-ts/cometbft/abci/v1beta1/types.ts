...
export const Request: MessageFns<Request> = {
  encode(message: Request, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.setOption !== undefined) {
      RequestSetOption.encode(message.setOption, writer.uint32(34).fork()).join();
    }
...
export const RequestBeginBlock: MessageFns<RequestBeginBlock> = {
  encode(message: RequestBeginBlock, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.lastCommitInfo !== undefined) {
      LastCommitInfo.encode(message.lastCommitInfo, writer.uint32(26).fork()).join();
    }
...
export const Response: MessageFns<Response> = {
  encode(message: Response, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.setOption !== undefined) {
      ResponseSetOption.encode(message.setOption, writer.uint32(42).fork()).join();
    }
    if (message.initChain !== undefined) {
...
export const ABCIApplicationServiceName = "cometbft.abci.v1beta1.ABCIApplication";
